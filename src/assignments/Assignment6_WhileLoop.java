...
public class Assignment6_WhileLoop {
	...
	void findMinNoToGetSum() {
		...
		System.out.println("Minimum Required Num to generate sum of 100 is " + num);
	}

	void printNumDivBy7Or13(int startRan, int endRan) {
		int count = 0;
		while (startRan <= endRan && count < 3) {
			if (startRan % 17 == 0) {
	...
	public static void main(String[] args) {
		Assignment6_WhileLoop whileLoop = new Assignment6_WhileLoop();
